...
import { ArrowUpRight, Code2, Palette, Box, Compass, LucideIcon } from "lucide-react";
...
function ServiceCard({ service, i }: { service: Service; i: number }) {
  ...
  return (
    <motion.div
      ...
      className="relative p-6 md:p-8 rounded-2xl flex flex-col group cursor-pointer"
      style={{
    ...
    >
      ...
      <p
        className="text-sm leading-relaxed mb-6 md:mb-8 flex-grow"
